# Agent Trading Journal Architecture

## Overview

Agent Trading Journal is packaged as a self-contained static web application. The page renders a product-grade AI-agent workflow without any server-side dependency.
