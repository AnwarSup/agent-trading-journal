# Reviewer Guide — Trading Journal AI
...
## Product objective
Analyze trade journal behavior and risk discipline.
...
print(run_pipeline_sync("Trading Journal AI", {"subject":"trade_review reviewer smoke"}))
PY
```
