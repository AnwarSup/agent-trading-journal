"""Agentic Trading Journal multi-agent reasoning core.
...
PROJECT_NAME = 'Agentic Trading Journal'
DOMAIN = 'trade analytics'
AUDIENCE = 'active traders and fund operators'
AGENT_ROLES = ['Trade Ingest Agent', 'Thesis Consistency Checker', 'Risk Discipline Auditor', 'Pattern Miner', 'Coaching Plan Generator']
SIGNALS = ['risk_reward', 'max_adverse_excursion', 'plan_deviation', 'holding_time_hours', 'emotion_tag_risk']
SCENARIOS = ['weekly performance review', 'loss cluster analysis', 'strategy discipline audit']
